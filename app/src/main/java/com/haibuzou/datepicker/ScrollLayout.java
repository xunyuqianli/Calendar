...
public class ScrollLayout extends FrameLayout implements MonthView.OnLineCountChangeListener,
    ...
    protected void measureChild(View child, int parentWidthMeasureSpec, int parentHeightMeasureSpec) {
        ...
        //childHeightMeasureSpec = getChildMeasureSpec(parentHeightMeasureSpec,getPaddingBottom()+getPaddingTop(), lp.height);
        childHeightMeasureSpec = MeasureSpec.makeMeasureSpec(Integer.MAX_VALUE >> 2, MeasureSpec.AT_MOST);
    ...
    protected void measureChildWithMargins(View child, int parentWidthMeasureSpec, int widthUsed,
        ...
        //final int childHeightMeasureSpec = getChildMeasureSpec(parentHeightMeasureSpec,getPaddingBottom()+getPaddingTop(), lp.height);
        final int childHeightMeasureSpec  = MeasureSpec.makeMeasureSpec(Integer.MAX_VALUE >> 2, MeasureSpec.AT_MOST);
